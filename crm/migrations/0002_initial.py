...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='deal',
            name='agency',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tenants.agency', verbose_name='Agency/Tenant'),
        ),
        migrations.AddField(
            model_name='deal',
            name='city',
        ...
        migrations.AddField(
            model_name='deal',
            name='country',
            field=models.ForeignKey(blank=True, help_text='Country', null=True, on_delete=django.db.models.deletion.SET_NULL, to='locations.country', verbose_name='country'),
        ),
        migrations.AddField(
            model_name='deal',
            name='currency',
