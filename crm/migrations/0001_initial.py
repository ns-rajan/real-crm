    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case', models.BooleanField(default=False, help_text='A request that does not involve payment', verbose_name='Case/Incident')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consent_timestamp', models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('document_type', models.CharField(choices=[('passport', 'Passport'), ('national_id', 'National ID'), ('nif_document', 'NIF / Tax ID'), ('bank_statement', 'Bank Statement'), ('lease_statement', 'Lease Statement'), ('driving_licence', 'Driving Licence'), ('other', 'Other')], default='other', max_length=50)),
                ('file', models.FileField(upload_to='kyc_docs/%Y/%m/')),
                ('uploaded_at', models.DateTimeField(auto_now_add=True)),
                ('is_verified', models.BooleanField(default=True)),
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='kyc_documents', to='crm.contact')),
            ],
        ),
        migrations.AddField(
            model_name='city',
